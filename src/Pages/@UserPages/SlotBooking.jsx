    ...
    if (token) {
      ...
      try {
        ...
        setTimeSlots((prevSlots) =>
          prevSlots.filter((slot) => !selectedSlots.includes(slot))
        );
        setSelectedSlots([]);
      ...
      <div className="container bg-light d-flex p-2 mt-2">
        ...
        >
          <div className="row p-2">
            <div
              className={
                cart ? `col-md-6    p-2  border` : `col-md-12 p-2     border`
              }
              style={{
                backgroundColor: "",
              }}
              ...
              <div className="col-md-6 p-0 border  ">
                <div className="container  ">
                  <div className="text-light bg-success mt-2">
                    <h3 className="p-2 fw-bold fs-2 pt-4 text-center">
                      Booking{" "}
                    </h3>
                  ...
                  <hr />
                  <div
                    className="cartItem p-2 "
                    style={{ backgroundColor: "beige", borderRadius: "10px" }}
                  >
                    <p style={{ fontSize: "1rem" }}> Sport:{sport}</p>
                    ...
                    <div className="text-center text-light p-2 mb-2">
                      <Button
                        ...
                        className=" text-center w-100 btn-rounded btn btn-success"
                        onClick={handleBooking}
                      >
                        {isFormFilled
                          ? "Pay ₹150 | Confirm Slot"
                          : "Fill out Fields"}
                      </Button>
                    </div>
                  </div>
